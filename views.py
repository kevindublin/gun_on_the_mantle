...
def example_endgame(request):
    context = {}
    return render(request, "example-endgame.html", context)


def example_challenge(request):
    context = {}
    return render(request, "example-challenge.html", context)
